...
public:
   ...
   constexpr DATA_TYPE& x() { return this->mData[0]; }
   constexpr DATA_TYPE& y() { return this->mData[1]; }
   constexpr DATA_TYPE& z() { return this->mData[2]; }
   constexpr DATA_TYPE& w() { return this->mData[3]; }

   constexpr const DATA_TYPE& x() const { return this->mData[0]; }
   constexpr const DATA_TYPE& y() const { return this->mData[1]; }
   constexpr const DATA_TYPE& z() const { return this->mData[2]; }
   constexpr const DATA_TYPE& w() const { return this->mData[3]; }
